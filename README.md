...
[![Container Repository on Quay](https://quay.io/repository/samdoran/centos6-ansible/status "Container Repository on Quay")](https://quay.io/repository/samdoran/centos6-ansible)
...
To build your own version of this container, run:
    ...
    podman build -t centos6-ansible .
