...
[![Docker Repository on Quay](https://quay.io/repository/samdoran/centos6-ansible/status "Docker Repository on Quay")](https://quay.io/repository/samdoran/centos6-ansible)
...
platforms:
  - name: role-test
    image: "samdoran/${MOLECULE_DISTRIBUTION:-centos6}-ansible:latest"
